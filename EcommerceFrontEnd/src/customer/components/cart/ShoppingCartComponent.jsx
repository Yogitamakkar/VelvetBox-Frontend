            ...
            <div className='lg:max-h-5'>
                {
                    cartItems.map((cartItem)=>(
                        <OrderSummary key={cartItem.id} cartItems={cartItem} totalItems={totalItems} total={total} subtotal={subtotal} deliveryFee={deliveryFee} />
                    ))
                }
            </div>
